...
public class EnergyBall {
	...
	public static void makeStar(World world, double x, double y, double z, double red, double green, double purple, double maxRange){
		...
		while(range < maxRange){
			range += 0.1;
			world.spawnParticle("reddust", x + 0, y + 0, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + range, y + range, z + range, red, green, purple);
			world.spawnParticle("reddust", x + range, y + range, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + range, y + range, z - range, red, green, purple);
			world.spawnParticle("reddust", x + range, y + 0, z + range, red, green, purple);
			world.spawnParticle("reddust", x + range, y + 0, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + range, y + 0, z - range, red, green, purple);
			world.spawnParticle("reddust", x + range, y - range, z + range, red, green, purple);
			world.spawnParticle("reddust", x + range, y - range, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + range, y - range, z - range, red, green, purple);
			...
			world.spawnParticle("reddust", x + 0, y + 0, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + 0, y + range, z + range, red, green, purple);
			world.spawnParticle("reddust", x + 0, y + range, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + 0, y + range, z - range, red, green, purple);
			world.spawnParticle("reddust", x + 0, y + 0, z + range, red, green, purple);
			world.spawnParticle("reddust", x + 0, y + 0, z + 0, red, green, purple);
			world.spawnParticle("reddust", x + 0, y + 0, z - range, red, green, purple);
			world.spawnParticle("reddust", x + 0, y - range, z + range, red, green, purple);
			world.spawnParticle("reddust", x + 0, y - range, z + 0, red, green, purple);
	...
	public static void makeBall(World world, double x, double y, double z, double maxRange, double red, double green, double purple, int maxTimes){
		...
		while(times < maxTimes){
			...
			if(pos.getSquaredDistance(pos2) <= maxRange){
