	...
	public void deathEvent(LivingDeathEvent event){
		...
		if(event.source.getEntity() instanceof EntityPlayer){
			...
			if(WorldData.getBooleanOption(player, "killMessages", true)){
				player.addChatMessage(new ChatComponentTranslation(EnumChatFormatting.GOLD + "You have killed " + event.entityLiving.getCommandSenderName() + "."));
			}
		}
		if(event.source.getEntity() != null && event.entityLiving instanceof EntityPlayer){
			...
			if(WorldData.getBooleanOption(player, "deathMessages", true)){
				player.addChatMessage(new ChatComponentTranslation(EnumChatFormatting.DARK_RED + "You are killed by " + event.source.getEntity().getCommandSenderName() + "."));
			}
		}
		if(event.source.getEntity() == null && event.entityLiving instanceof EntityPlayer){
