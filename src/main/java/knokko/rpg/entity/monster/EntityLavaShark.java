...
public class EntityLavaShark extends EntityFlying implements IMob{
	...
	public void onUpdate(){
		super.onUpdate();
		if(handleLavaMovement() || isInWater()){
			onSwimmingUpdate();
		}
		else {
			motionY = -0.2;
		...
		if(getAttackTarget() == null){
			...
			distanceToTarget = new Position(this).getSquaredDistance(new Position(getAttackTarget()));
	...
	public boolean isCreatureType(EnumCreatureType type, boolean b){
		return type == EnumCreatureType.waterCreature;
	}
}
