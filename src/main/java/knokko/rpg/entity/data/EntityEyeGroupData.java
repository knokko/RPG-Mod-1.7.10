	...
	public void onUpdate(){
		...
		if(leader == null && !worldObj.isRemote){
			if(leaderId != null && !leaderId.isEmpty()){
				...
				leader = (EntityEye) worldObj.findNearestEntityWithinAABB(EntityEye.class, AxisAlignedBB.getBoundingBox(posX - 64, posY - 64,  posZ - 64,  posX + 64, posY + 64, posZ + 64), this);
			}
			if(ticksExisted > 40){
				setDead();
			}
