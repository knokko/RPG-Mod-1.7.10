...
public class ModelEye extends ModelBase{
    ...
    public ModelEye(float f)
    {
        this(f, 0.0F, 64, 32);
    }

    public ModelEye(float f1, float f2, int f3, int i1)
    {
        this.textureWidth = f3;
        this.textureHeight = i1;
        ...
        this.bipedBody.addBox(-2.0F, 0.0F, -1.0F, 4, 12, 2, f1);
        this.bipedBody.setRotationPoint(0.0F, 0.0F + f2, 0.0F);
        this.bipedRightArm = new ModelRenderer(this, 40, 16);
        this.bipedRightArm.addBox(-1.5F, -2.0F, -1.0F, 2, 12, 2, f1);
        this.bipedRightArm.setRotationPoint(-5.0F, 2.0F + f2, 0.0F);
        this.bipedLeftArm = new ModelRenderer(this, 40, 16);
        this.bipedLeftArm.mirror = true;
        this.bipedLeftArm.addBox(-0.5F, -2.0F, -1.0F, 2, 12, 2, f1);
        this.bipedLeftArm.setRotationPoint(5.0F, 2.0F + f2, 0.0F);
        this.sideArm = new ModelRenderer(this, 40, 16);
        this.sideArm.addBox(-0.5F, -2.0F, -1.0F, 10, 2, 2);
        this.sideArm.setRotationPoint(-4, 2.0F + f2, 0);
    ...
    {
        this.setRotationAngles(f1, f2, f3, f4, f5, f7, entity);
     ...
     */
    public void setRotationAngles(float f1, float f2, float f3, float f4, float f5, float p6, Entity entity)
    {
